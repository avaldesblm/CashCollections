...
INSERT INTO Roles (nombre) values('ROLE_OPS');
...
INSERT INTO Usuarios (username, password, nombre, apellido, mail) VALUES('pedro', '$2a$10$jBi6WN6BeREjtc7/6zRXq.bvKZazc1LfsoWAC2P.Vr8fHhYZfDDp6', 'Pedro', 'Perez', 'pedro@bluelabel.mx');
INSERT INTO usuarios_roles (user_id, role_id) values (1,1);
INSERT INTO usuarios_roles (user_id, role_id) values (2,2);
INSERT INTO usuarios_roles (user_id, role_id) values (3,3);
INSERT INTO causas_cancelacion (name,description,enable) values ('Razon_1','No quiere la firma', 1);
INSERT INTO causas_cancelacion (name,description,enable) values ('Razon_2','Se equivoco', 1);
INSERT INTO causas_cancelacion (name,description,enable) values ('Razon_3','No la pago el merchant', 1);